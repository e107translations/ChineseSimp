...
define("CUSLAN_29", "如果未选择任何页面，列表的网页");
define("CUSLAN_30", "Cookie 到期时间 （以秒为单位）");
define("CUSLAN_31", "创建菜单");
...
define("CUSLAN_56", "父");
define("CUSLAN_57", "请选择此项独特海基会 URL 字符串。");
define("CUSLAN_58", "在这一章的查看页面");
define("CUSLAN_59", "页面");
...
define("CUSLAN_67", "菜单模板");
define("CUSLAN_68", "自定义按钮文本");
define("CUSLAN_69", "自定义按钮的 URL");
define("CUSLAN_70", "菜单图标/标志符号");
define("CUSLAN_71", "菜单的图像视频");
define("CUSLAN_72", "书/章节列表模板");
define("CUSLAN_73", "创建菜单");
define("CUSLAN_74", "更新的菜单");
define("CUSLAN_75", "缺少菜单-id 检测到 ︰");
